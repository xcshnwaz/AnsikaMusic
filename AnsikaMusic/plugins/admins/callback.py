...
from AnsikaMusic import YouTube, app
from AnsikaMusic.core.call import SHUKLA
from AnsikaMusic.misc import SUDOERS, db
from AnsikaMusic.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from AnsikaMusic.utils.formatters import seconds_to_min
from AnsikaMusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from AnsikaMusic.utils.stream.autoclear import auto_clean
from AnsikaMusic.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
