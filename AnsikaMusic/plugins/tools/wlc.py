...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("AnsikaMusic/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('AnsikaMusic/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('AnsikaMusic/assets/font.ttf', size=60)
...
async def greet_new_member(_, member: ChatMemberUpdated):
    ...
    if member.new_chat_member and not member.old_chat_member:
        ...
        try:
            ...
            pic = "AnsikaMusic/assets/upic.png"
